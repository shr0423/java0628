...
public class LoginForm extends Frame{
	...
	Panel p_south;//남쪽 영역에 버튼들을포함하게 될 패널선언
	...
	public LoginForm() {
		...
		//하지만, 내가 곧 윈도우이므로 즉 프레임이므로 레퍼런스 변수는 나를 가리키는 
		//this를사용할 수 잇따. 
		...
		this.setSize(300,120);//나의 크기설정
		this.setVisible(true);//나를보이게
	}
